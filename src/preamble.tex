...
% Handles microtypography, makes small changes to produce better output.
% doesn't work well with XeTeX
\usepackage{microtype}
\usepackage{tocstyle}
\addtokomafont{chapterentry}{\rmfamily\normalfont}
\renewcommand{\contentsname}{contents}
\newcommand{\mynote}{\footnote}
...
% }                                                      %  single quotes not
%
\setmonofont{Inconsolata g}                          %  to turn out curly
                                                       %  ("typographic")
